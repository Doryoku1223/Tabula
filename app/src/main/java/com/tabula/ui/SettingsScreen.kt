...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                SectionHeader(title = stringResource(R.string.settings_section_appearance_language))
                Spacer(modifier = Modifier.height(12.dp))
                Text(
            ...
            item {
                ...
                Column(
                    ...
                    Spacer(modifier = Modifier.height(8.dp))
                    Text(text = stringResource(R.string.app_name), color = fg, style = MaterialTheme.typography.titleMedium)
                    Text(text = stringResource(R.string.settings_version), color = fg, style = MaterialTheme.typography.bodyMedium)
                    Spacer(modifier = Modifier.height(12.dp))
                    Text(
